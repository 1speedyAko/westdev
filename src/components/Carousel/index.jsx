...
const Carousel = ()=>{
    return(
        ...
        {/* <div className="relative h-56  rounded-none md:h-96 bg-white  " data-carousel="slide">
         ...
         <div className="hidden duration-700 text-red-500 ease-in-out" data-carousel-item>
             moses
         </div>
     </div>
     ...
     <button type="button" className="absolute top-0 left-0 z-0 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
